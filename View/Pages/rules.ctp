          ...
          <ol>
            ...
            <li>Differenz des Ergebnisses:
              <ul class="list-unstyled">
                <li><em>Beispiel: tatsaechliches Ergebnis: 2:1 bedeutet eine Differenz von 1.
Tip: 3:1 bedeutet eine Differenz von 2. Zusammen: Differenz zwischen Realitaet und Tip: 1, macht also 4 Extrapunkte zu den 12 wegen der richtigen Tendenz.</em>
                </li>
                <li>
                  Die Verteilung:
            ...
            <li>Differenz zu den erzielten Toren je Mannschaft:
              <ul class="list-unstyled">
                <li><em>Erst jede Seite einzeln vergleichen, dann beide Differenzen addieren und die Punkte zuordnen. <br>Beispiel: tatsaechliches Ergebnis: 2:1, Tip: 3:1. Daraus ergibt sich:
                  <ul class="list-unstyled">
                    <li>3:1</li>
                    <li>2:1</li>
          ...
          <p>Aus Euren Tips ergeben sich Tabellen fuer die einzelnen Vorrundengruppen. Diese werden mit den tatsaechlichen Endtabellen verglichen. Dabei koennen nach Ende der Vorrunde Bonuspunkte eingefahren werden</p>
          <ol>
            <li>Fuer einen richtig getippten Tabellenplatz gibt es <strong>4 Punkte</strong></li>
            <li>Fuer richtig getippte Punkte einer Mannschaft werden Euch nochmal <strong>2 Punkte</strong> gutgeschrieben</li>
            <li>Fuer richtig getipptes Torverhaeltnis gibt es <strong>1 Punkt</strong></li>
          </ol>
