...
<?php echo $this->Form->create('Tipp'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Tipp'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tipp.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Tipp.id'))); ?></li>
